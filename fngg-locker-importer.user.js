...
(function() {
    ...
    var I18N = {
        en: {
            ...
            fnggUnreachable: 'fortnite.gg not reachable', noItems: 'No items found',
        ...
        de: {
            ...
            fnggUnreachable: 'fortnite.gg nicht erreichbar', noItems: 'Keine Items gefunden',
    ...
    async function loadAccountStats() {
        ...
        try {
            ...
            if (!fnggMapMem) {
                try {
                    var fm2 = await http('GET', 'https://fortnite.gg/api/items.json');
    ...
    function createUI() {
        ...
        if (dp) {
            ...
            $('diagbtn').onclick = async function() {
                ...
                try {
                    var r1 = await http('GET', 'https://fortnite.gg/api/items.json');
                    lines.push(r1.status === 200 ? '<span style="color:#4ade80">✓</span> fortnite.gg API reachable' : '<span style="color:#ef4444">✗</span> fortnite.gg API error (' + r1.status + ')');
